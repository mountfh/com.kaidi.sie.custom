...
public class ChangeBOMLog {
	
	public static Logger logger = Logger.getLogger("changeBOMLog");
	public static String configPath = "configuration" + File.separator + "changeBOMLog.properties";
	...
	public static void initLogConfig() {
		...
		try {
			...
			file = new File(url);
			if (!file.exists()) {
				URL url4j = NewPartLog.class.getResource("changeBOMLog.properties");
